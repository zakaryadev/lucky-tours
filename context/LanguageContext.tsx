...
const translations: Record<Language, Record<string, string>> = {
  uz: {
    ...
    // Payment Page
    "payment.heroLabel": "ONLINE TO'LOV",
    "payment.heroTitle": "QR Kod Orqali Qulay To'lov",
    "payment.heroDesc": "Paynet tizimi orqali istalgan bank va to'lov ilovalaridan (Payme, Click, Uzum va h.k.) tezkor va xavfsiz to'lang.",
    "payment.qrScanText": "QR kodni skanerlang va istalgan ilova orqali to'lang",
    "payment.recipientLabel": "To'lovni Qabul Qiluvchi",
    "payment.recipientName": "SHAXRUX AXMEDOV OLIMJON O'G'LI",
    "payment.systemLabel": "To'lov Tizimi",
    "payment.systemName": "Paynet QR",
    "payment.copyBtn": "Nusxalash",
    "payment.copiedBtn": "Nusxalandi!",
    "payment.downloadQr": "QR Kodni yuklab olish",
    "payment.supportedApps": "Istalgan ilova orqali to'lash mumkin",
    "payment.stepsTitle": "Qanday qilib to'lov qilinadi?",
    "payment.step1Title": "1. Ilovani oching",
    "payment.step1Desc": "Mobil telefoningizdagi istalgan bank (NBU, Agrobank, Kapitalbank va h.k.) yoki to'lov ilovasini (Payme, Click, Uzum) oching.",
    "payment.step2Title": "2. QR kodni skanerlang",
    "payment.step2Desc": "Ilovadagi QR-skaner bo'limiga kirib, ekrandagi QR kodni skanerlang yoki galereyadan rasm sifatida tanlang.",
    "payment.step3Title": "3. To'lovni tasdiqlang",
    "payment.step3Desc": "Sayohat yoki xizmat summasini kiriting, qabul qiluvchi ismini tekshiring va to'lovni tasdiqlang.",
    "payment.helpTitle": "Savollaringiz bormi?",
    "payment.helpDesc": "To'lov jarayonida qiyinchilik bo'lsa, bizning qo'llab-quvvatlash markazimizga murojaat qiling.",
    "payment.callSupport": "Menejer bilan bog'lanish",
  ...
  en: {
    ...
    // Payment Page
    "payment.heroLabel": "ONLINE PAYMENT",
    "payment.heroTitle": "Convenient Payment via QR Code",
    "payment.heroDesc": "Pay quickly and securely via Paynet using any bank or payment app (Payme, Click, Uzum, etc.).",
    "payment.qrScanText": "Scan the QR code and pay via any app",
    "payment.recipientLabel": "Payment Recipient",
    "payment.recipientName": "SHAXRUX AXMEDOV OLIMJON O'G'LI",
    "payment.systemLabel": "Payment System",
    "payment.systemName": "Paynet QR",
    "payment.copyBtn": "Copy Name",
    "payment.copiedBtn": "Copied!",
    "payment.downloadQr": "Download QR Code",
    "payment.supportedApps": "Accepted by all major banking & payment apps",
    "payment.stepsTitle": "How to Make a Payment?",
    "payment.step1Title": "1. Open your App",
    "payment.step1Desc": "Open your preferred banking app (NBU, Agrobank, Kapitalbank, etc.) or payment app (Payme, Click, Uzum).",
    "payment.step2Title": "2. Scan the QR Code",
    "payment.step2Desc": "Use the QR scanner in your app to scan the code on screen or upload it from your gallery.",
    "payment.step3Title": "3. Confirm Payment",
    "payment.step3Desc": "Enter the tour or service amount, verify recipient name, and confirm transaction.",
    "payment.helpTitle": "Have Questions?",
    "payment.helpDesc": "If you experience any issues during payment, feel free to contact our support team.",
    "payment.callSupport": "Contact Support",
